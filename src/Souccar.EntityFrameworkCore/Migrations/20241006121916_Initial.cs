    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClearanceCompanies", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClearanceCompanyBalances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClearanceCompanyBalances_ClearanceCompanies_ClearanceCompanyId",
                        column: x => x.ClearanceCompanyId,
                        principalTable: "ClearanceCompanies",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "ClearanceCompanyCashFlows",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClearanceCompanyCashFlows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClearanceCompanyCashFlows_ClearanceCompanies_ClearanceCompanyId",
                        column: x => x.ClearanceCompanyId,
                        principalTable: "ClearanceCompanies",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerCashFlows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerCashFlows_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierOffers_Customers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransportCompanyBalances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TransportCompanyBalances_TransportCompanies_TransportCompanyId",
            ...
            migrationBuilder.CreateTable(
                name: "TransportCompanyCashFlows",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransportCompanyCashFlows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TransportCompanyCashFlows_TransportCompanies_TransportCompanyId",
                        column: x => x.TransportCompanyId,
                        principalTable: "TransportCompanies",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UnitSizes_Sizes_SizeId",
                        column: x => x.SizeId,
                        principalTable: "Sizes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UnitSizes_Units_UnitId",
                        column: x => x.UnitId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DamagedNumberInLargeUnit = table.Column<double>(type: "float", nullable: false),
                    DamagedNumberInSmallUnit = table.Column<double>(type: "float", nullable: false),
                    UnitId = table.Column<int>(type: "int", nullable: true),
                    SizeId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OfferItems_Customers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Customers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OfferItems_Materials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materials",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OfferItems_Sizes_SizeId",
                        column: x => x.SizeId,
                        principalTable: "Sizes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OfferItems_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invoices_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Invoices_AbpUsers_DeleterUserId",
                        column: x => x.DeleterUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Invoices_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Invoices_SupplierOffers_SupplierOfferId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierOfferItems_Customers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Customers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SupplierOfferItems_Materials_MaterialId",
                        column: x => x.MaterialId,
                        principalTable: "Materials",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SupplierOfferItems_Sizes_SizeId",
                        column: x => x.SizeId,
                        principalTable: "Sizes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SupplierOfferItems_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Receivings_AbpUsers_CreatorUserId",
                        column: x => x.CreatorUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Receivings_AbpUsers_DeleterUserId",
                        column: x => x.DeleterUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Receivings_AbpUsers_LastModifierUserId",
                        column: x => x.LastModifierUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Receivings_ClearanceCompanies_ClearanceCompanyId",
                        column: x => x.ClearanceCompanyId,
                        principalTable: "ClearanceCompanies",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Receivings_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Receivings_TransportCompanies_TransportCompanyId",
                        column: x => x.TransportCompanyId,
                        principalTable: "TransportCompanies",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApprovedQuantity = table.Column<double>(type: "float", nullable: false),
                    ...
                    DeliveryItemStatus = table.Column<int>(type: "int", nullable: false),
                    DeliveryId = table.Column<int>(type: "int", nullable: true),
                    OfferItemId = table.Column<int>(type: "int", nullable: true),
                    SupplierOfferItemId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliveryItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeliveryItems_Deliverys_DeliveryId",
                        column: x => x.DeliveryId,
                        principalTable: "Deliverys",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DeliveryItems_OfferItems_OfferItemId",
                        column: x => x.OfferItemId,
                        principalTable: "OfferItems",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DeliveryItems_SupplierOfferItems_SupplierOfferItemId",
                        column: x => x.SupplierOfferItemId,
                        principalTable: "SupplierOfferItems",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InvoiceItems_OfferItems_OfferItemId",
                        column: x => x.OfferItemId,
                        principalTable: "OfferItems",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_InvoiceItems_SupplierOfferItems_SupplierOfferItemId",
                        column: x => x.SupplierOfferItemId,
                        principalTable: "SupplierOfferItems",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleInvoiceItems_DeliveryItems_DeliveryItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReceivingItems_Customers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Customers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ReceivingItems_InvoiceItems_InvoiceItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClearanceCompanyBalances_ClearanceCompanyId",
                table: "ClearanceCompanyBalances",
                column: "ClearanceCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_ClearanceCompanyCashFlows_ClearanceCompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerCashFlows_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryItems_OfferItemId",
                table: "DeliveryItems",
                column: "OfferItemId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryItems_SupplierOfferItemId",
                table: "DeliveryItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceItems_OfferItemId",
                table: "InvoiceItems",
                column: "OfferItemId");

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceItems_SupplierOfferItemId",
                table: "InvoiceItems",
                column: "SupplierOfferItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_DeleterUserId",
                table: "Invoices",
                column: "DeleterUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_SupplierOfferId",
                table: "Invoices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfferItems_SizeId",
                table: "OfferItems",
                column: "SizeId");

            migrationBuilder.CreateIndex(
                name: "IX_OfferItems_SupplierId",
                table: "OfferItems",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_OfferItems_UnitId",
                table: "OfferItems",
                column: "UnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReceivingItems_InvoiceItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReceivingItems_SupplierId",
                table: "ReceivingItems",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_Receivings_ClearanceCompanyId",
                table: "Receivings",
                column: "ClearanceCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Receivings_CreatorUserId",
                table: "Receivings",
                column: "CreatorUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Receivings_DeleterUserId",
                table: "Receivings",
                column: "DeleterUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Receivings_InvoiceId",
                table: "Receivings",
                column: "InvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Receivings_LastModifierUserId",
                table: "Receivings",
                column: "LastModifierUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Receivings_TransportCompanyId",
                table: "Receivings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierOfferItems_MaterialId",
                table: "SupplierOfferItems",
                column: "MaterialId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierOfferItems_SizeId",
                table: "SupplierOfferItems",
                column: "SizeId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierOfferItems_SupplierId",
                table: "SupplierOfferItems",
                column: "SupplierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierOfferItems_UnitId",
                table: "SupplierOfferItems",
                column: "UnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransportCompanyBalances_TransportCompanyId",
                table: "TransportCompanyBalances",
                column: "TransportCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportCompanyCashFlows_TransportCompanyId",
                table: "TransportCompanyCashFlows",
                column: "TransportCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_UnitSizes_SizeId",
                table: "UnitSizes",
                column: "SizeId");

            migrationBuilder.CreateIndex(
                name: "IX_UnitSizes_UnitId",
                table: "UnitSizes",
                column: "UnitId");
        }
