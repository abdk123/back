...
namespace Souccar.Migrations
{
    ...
    [Migration("20241129080315_Add_Price_ToStock")]
    partial class Add_Price_ToStock
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Souccar.Hr.Employees.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Souccar.SaleManagement.CachFlows.TransportCompanyCachFlows.TransportCompanyCashFlow", b =>
                {
                    ...
                    b.ToTable("TransportCompanyCashFlows");
                });
            ...
            modelBuilder.Entity("Souccar.SaleManagement.CashFlows.ClearanceCompanyCashFlows.ClearanceCompanyCashFlow", b =>
                {
                    ...
                    b.ToTable("ClearanceCompanyCashFlows");
                });
            ...
            modelBuilder.Entity("Souccar.SaleManagement.CashFlows.CustomerCashFlows.CustomerCashFlow", b =>
                {
                    ...
                    b.ToTable("CustomerCashFlows");
                });

            modelBuilder.Entity("Souccar.SaleManagement.Deliveries.Delivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Souccar.SaleManagement.Deliveries.DeliveryItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DeliveryItemStatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Souccar.SaleManagement.Deliveries.RejectedMaterial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Souccar.SaleManagement.Offers.OfferItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Souccar.SaleManagement.SaleInvoices.SaleInvoice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("DateForPaid")
                        .HasColumnType("datetime2");

                    b.Property<int>("DaysForPaid")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PillURN")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("SaleCurrency")
                        .HasColumnType("int");

                    b.Property<int>("SaleDescount")
                        .HasColumnType("int");

                    b.Property<int>("SaleTakeBalance")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Souccar.SaleManagement.SaleInvoices.SaleInvoiceItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Souccar.SaleManagement.Settings.Companies.ClearanceCompanyVoucher", b =>
                {
                    ...
                    b.ToTable("ClearanceCompanyBalances");
                });
            ...
            modelBuilder.Entity("Souccar.SaleManagement.Settings.Companies.TransportCompanyVoucher", b =>
                {
                    ...
                    b.ToTable("TransportCompanyBalances");
                });
            ...
            modelBuilder.Entity("Souccar.SaleManagement.Stocks.Stock", b =>
                {
                    ...
                    b.Property<double>("DamagedQuantity")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Souccar.SaleManagement.SupplierOffers.SupplierOfferItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Souccar.SaleManagement.Deliveries.DeliveryItem", b =>
                {
                    b.HasOne("Souccar.SaleManagement.Deliveries.Delivery", "Delivery")
                        .WithMany("DeliveryItems")
                        .HasForeignKey("DeliveryId");

                    b.HasOne("Souccar.SaleManagement.Offers.OfferItem", "OfferItem")
                        .WithMany("DeliveryItems")
                        .HasForeignKey("OfferItemId");

                    b.HasOne("Souccar.SaleManagement.SupplierOffers.SupplierOfferItem", null)
                        .WithMany("DeliveryItems")
            ...
            modelBuilder.Entity("Souccar.SaleManagement.Deliveries.RejectedMaterial", b =>
                {
                    b.HasOne("Souccar.SaleManagement.Deliveries.DeliveryItem", "DeliveryItem")
                        .WithMany("RejectedMaterials")
            ...
            modelBuilder.Entity("Souccar.SaleManagement.Offers.OfferItem", b =>
                {
                    ...
                    b.HasOne("Souccar.SaleManagement.Offers.Offer", "Offer")
                        .WithMany("OfferItems")
            ...
            modelBuilder.Entity("Souccar.SaleManagement.PurchaseInvoices.PurchaseInvoice", b =>
                {
                    ...
                    b.HasOne("Souccar.SaleManagement.SupplierOffers.SupplierOffer", "SupplierOffer")
            ...
            modelBuilder.Entity("Souccar.SaleManagement.PurchaseInvoices.PurchaseInvoiceItem", b =>
                {
                    ...
                    b.HasOne("Souccar.SaleManagement.SupplierOffers.SupplierOfferItem", "SupplierOfferItem")
                        .WithMany("PurchaseInvoiceItems")
                        .HasForeignKey("SupplierOfferItemId");
            ...
            modelBuilder.Entity("Souccar.SaleManagement.SaleInvoices.SaleInvoiceItem", b =>
                {
                    ...
                    b.HasOne("Souccar.SaleManagement.SaleInvoices.SaleInvoice", "SaleInvoice")
            ...
            modelBuilder.Entity("Souccar.SaleManagement.Deliveries.DeliveryItem", b =>
                {
                    b.Navigation("RejectedMaterials");
                });
