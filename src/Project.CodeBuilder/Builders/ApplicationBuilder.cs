...
namespace Project.CodeGenerator
{
    public class ApplicationBuilder
    {
        ...
        public static void GenerateDtos(Type entityType, string folderPath)
        {
            ...
            GenerateDtoFile(entityType, dtoPath, "Paged");
        ...
        {
            var fileName = "";
            if (prefix.Equals("Paged"))
            {
                fileName = $"{prefix}{entityType.Name}ResultRequestDto.cs";
            }
            else
            {
                fileName = $"{prefix}{entityType.Name}Dto.cs";
            }
