...
{
    public class ClearanceCompanyCashFlowUpdateEventData : EventData
    {
        public ClearanceCompanyCashFlowUpdateEventData(double amountDollar, double amountDinar, TransactionName transactionName, int? clearanceCompanyId, int? relatedId = null, string transactionDetails = "", string note = "")
        {
