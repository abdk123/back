...
namespace Souccar.SaleManagement.CashFlows.ClearanceCompanyCashFlows.Events
{
    ...
    {
        public ClearanceCompanyCashFlowDeleteEventData(double amountDollar, double amountDinar, string transactionDetails, string note, TransactionName transactionName, int? clearanceCompanyId)
        {
